...
//                 await expect(smartIntelligenceLicense.adopt()).to.revertedWith("Sale is not active currently.");
//             })
...
//                 await expect(smartIntelligenceLicense.connect(addr1).adopt()).to.revertedWith("The ERC20 token amount sent is not correct or Insuffient ERC20 Token amount sent.");
//             })
//         })
...
//                 await smartIntelligenceLicense.connect(addr1).adopt();
...
//                 await paymentToken.transfer(addr1.address, mintPrice);
//                 await paymentToken.connect(addr1).approve(smartIntelligenceLicense.address, mintPrice);
//                 await expect(smartIntelligenceLicense.connect(addr1).adopt())
